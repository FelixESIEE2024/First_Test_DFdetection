...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-npy', dest='save_npy', action='store_true', help='save raw depth matrix as .npy')
    parser.add_argument('--no-vis', dest='no_vis', action='store_true', help='do not write visualization images')
    ...
    for filename in tqdm(filenames):
        ...
        if args.save_npy:
            ...
            np.save(os.path.join(args.outdir, base_name[:base_name.rfind('.')] + '_depth.npy'), depth.cpu().numpy().astype(np.float32))
